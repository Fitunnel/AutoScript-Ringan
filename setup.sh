...
echo -e "$BGreen 2. Gunakan Domain Sendiri (Rekomendasi) $NC"
echo -e "$BYellow----------------------------------------------------------$NC"
read -rp " input 1 or 2 / pilih 1 atau 2 : " dns
if test $dns -eq 1; then
wget https://raw.githubusercontent.com/Fitunnel/AutoScript-Ringan/main/ssh/cf && chmod +x cf && ./cf
elif test $dns -eq 2; then
read -rp "Masukan domain : " dom
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Fitunnel/AutoScript-Ringan/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Fitunnel/AutoScript-Ringan/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/Fitunnel/AutoScript-Ringan/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Fitunnel/AutoScript-Ringan/main/menu/versi  )
